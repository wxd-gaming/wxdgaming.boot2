 ...
 **/
public class BuildColumnInt implements IBuildColumn {

    @Override public void register(IColumnFactory columnFactory) {
        columnFactory.register(int.class, this);
        columnFactory.register(Integer.class, this);
        columnFactory.register(AtomicInteger.class, this);
    }

    public void buildColumn(TableMapping.FieldMapping fieldMapping) {
        fieldMapping.setColumnType(ColumnType.Int);
    }
