 ...
 **/
public class ColumnConvertJson implements IColumnConvert {

    @Override public void register(AbstractColumnConvertFactory columnConvertFactory) {
        columnConvertFactory.register(ColumnType.Json, this);
        columnConvertFactory.register(ColumnType.Jsonb, this);
    }
    ...
    @Override public Object toDb(TableMapping.FieldMapping fieldMapping, Object fieldValue) {
        ...
        if (fieldValue instanceof BitSet bitSet) {
