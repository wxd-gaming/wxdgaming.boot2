 ...
 **/
public class BuildColumnBool implements IBuildColumn {

    @Override public void register(IColumnFactory columnFactory) {
        columnFactory.register(boolean.class, this);
        columnFactory.register(Boolean.class, this);
        columnFactory.register(AtomicBoolean.class, this);
    }

    public void buildColumn(TableMapping.FieldMapping fieldMapping) {
        fieldMapping.setColumnType(ColumnType.Bool);
    }
