...
QBuffTable = {
["1-1"] = {id = "1-1", buffGroup = 1, buffId = 1, lv = 1, type = 1, addType = 0, addExecutor = false, addStatusList = "[]", clearType = 0, checkGroup = "[]", clearBuffIdList = "[]", clearGroupList = "[]", duration = 30000, interval = 100, paramInt1 = 0, paramInt2 = 0, paramInt3 = 0, paramString1 = "{\"HP\":10,\"MP\":10}", paramString2 = "", paramString3 = "" } ,
["2-1"] = {id = "2-1", buffGroup = 1, buffId = 2, lv = 1, type = 1, addType = 0, addExecutor = false, addStatusList = "[]", clearType = 0, checkGroup = "[]", clearBuffIdList = "[]", clearGroupList = "[]", duration = 30000, interval = 1000, paramInt1 = 1, paramInt2 = 0, paramInt3 = 0, paramString1 = "{\"HP\":1000,\"MP\":1000}", paramString2 = "", paramString3 = "" } ,
["3-1"] = {id = "3-1", buffGroup = 1, buffId = 3, lv = 1, type = 1, addType = 0, addExecutor = false, addStatusList = "[]", clearType = 0, checkGroup = "[]", clearBuffIdList = "[]", clearGroupList = "[]", duration = 30000, interval = 1000, paramInt1 = 0, paramInt2 = 0, paramInt3 = 0, paramString1 = "{\"HP\":-40,\"MP\":-40}", paramString2 = "", paramString3 = "" } ,
["4-1"] = {id = "4-1", buffGroup = 1, buffId = 4, lv = 1, type = 2, addType = 0, addExecutor = false, addStatusList = nil, clearType = 0, checkGroup = nil, clearBuffIdList = nil, clearGroupList = nil, duration = 30000, interval = 1000, paramInt1 = 0, paramInt2 = 0, paramInt3 = 0, paramString1 = "{\"MAXHP\":1000,\"MAXMP\":1000,\"体力\":100,\"攻击\":100,\"防御\":100}", paramString2 = "", paramString3 = "" } 
}
