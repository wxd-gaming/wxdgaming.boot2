...
class ExecutorServiceJob implements Runnable, Job {
    ...
    @Override public void run() {
        ...
        ExecutorUtil.Run_THREAD_LOCAL.put(currentThread, this);
        ExecutorUtil.CurrentThread.set(this);
        ...
        try {
            ...
            ExecutorUtil.CurrentThread.remove();
            ExecutorUtil.Run_THREAD_LOCAL.remove(currentThread);
