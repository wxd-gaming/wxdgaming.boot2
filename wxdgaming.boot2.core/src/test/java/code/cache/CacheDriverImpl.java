 ...
 **/
@Getter
public class CacheDriverImpl<K, V> {
    ...
    @Builder
    public CacheDriverImpl(String cacheName, int blockSize, Duration heartExpireAfterWrite, Duration expireAfterAccess, Duration expireAfterWrite, Function<K, V> loader, Consumer3<K, V, CacheDriver.RemovalCause> heartListener, Predicate3<K, V, CacheDriver.RemovalCause> removalListener) {
