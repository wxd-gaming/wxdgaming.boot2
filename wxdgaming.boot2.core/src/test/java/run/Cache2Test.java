...
import wxdgaming.boot2.core.cache.Cache2;
...
public class Cache2Test {
    ...
    public static void t0() throws InterruptedException {
        Cache2<Long, Long> cache = Cache2.<Long, Long>builder()
                .cacheName("test")
        ...
        System.out.println("Cache2 单线程 随机访问：" + cache.cacheSize() + ", " + c1 + " 次 耗时:" + diff + " ms");
        cache.shutdown();
    }
    ...
    public static void t1() throws InterruptedException {
        ...
        latch.await();
        float diff = diffTime.diff();
        System.out.println("Cache2 多线程 随机访问：" + cache.cacheSize() + ", " + c1 + " 次 耗时:" + diff + " ms");
        cache.shutdown();
    }
