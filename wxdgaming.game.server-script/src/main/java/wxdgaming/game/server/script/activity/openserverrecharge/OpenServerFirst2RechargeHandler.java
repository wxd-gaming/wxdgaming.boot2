...
@Slf4j
@Service
public class OpenServerFirst2RechargeHandler extends AbstractActivityHandler<ActivityData> {

    public OpenServerFirst2RechargeHandler() {

    }

    @Override public int activityType() {
        return ActivityConst.OPEN_SERVER_RECHARGE2;
    }
