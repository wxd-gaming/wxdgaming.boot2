 ...
 **/
@Component
public class VipConditionProcessor extends AbstractConditionProcessor<SelfBean> {
    ...
    @Override public String tips(SelfBean params, Condition condition) {
        return "当前VIP等级 %s级 不足 %s级".formatted(selfValue(params, condition), condition.targetValue());
    }
